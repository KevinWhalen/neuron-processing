...
public class thinning implements PlugInFilter {
	...
	public static void main(String[] args) {
		...
		ImagePlus im = IJ.openImage("G:\\IMAGE_PROCESSING\\abcd.tif");
	...
	public void run(ImageProcessor ip) {
		...
		while(st<=stacksize){
			...
			while(true){
				...
				LinkedList<Coordinates> branchCoords =  ColorBranches(orgCp,cp, DupB,i,j-1);	
	...
	public LinkedList<Coordinates> ColorBranches(ColorProcessor orgCp, ColorProcessor cp, ByteProcessor ip, int startx, int starty)
	{
